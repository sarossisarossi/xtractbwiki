...
ClassNameToExtract = r'wikitable sortable static-row-numbers plainrowheaders srn-white-background jquery-tablesorter'
DataNameToExtract = r'static-row-header'


table = soup.find("table", class_= ClassNameToExtract)
